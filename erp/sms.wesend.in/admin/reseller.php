        ...
        <div class="row">
               ...
               <!------add new reseller--------->
                ...
                if (isset($_GET['action'])) {
                    ...
                    <?php } elseif (($_GET['action']) == 'view' && ($_GET['unique_id'])) {
                        ...
                        $stmt = $conn->prepare("SELECT `id`, `full_name` ,`username`, `user_type`, `email_id`, `pwd`, `company`, profilepic,  `mobile`, `credit`, `status` FROM `logins` WHERE  user_unique_id = ?");
                        $stmt->bind_param("s", $_GET['unique_id']);
                        $stmt->execute();
                        $stmt->bind_result($r_id, $r_fullname, $r_username, $usertype, $r_email_id, $r_pwd, $r_company, $r_profile, $r_mobile, $credit, $status);
                        $stmt->fetch();
                        $conn->close();
                        ?>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="white-box">
                                    ...
                                    <hr>
                                    <div class="form-group row">
                                        <label class="col-lg-2 control-label " for="userName">profilepic <span
                                                    class="mandatory">*</span></label>
                                        <div class="col-lg-4">
                                    ...
                                    <hr>
                                    <div class="form-group row">
                                        <label class="col-lg-2 control-label " for="confirm">Status <span
                                                    class="mandatory">*</span></label>
                                        <div class="col-lg-4">
                                            <?php
                                            if ($status == 'Active') {
                    ...
                    <?php } elseif (($_GET['action']) == 'edit' && ($_GET['unique_id'])) {
                        ...
                        $stmt = $conn->prepare("SELECT `id`, `full_name` ,`username`, `user_type`, `email_id`, `pwd`, `company`, `profilepic`, `mobile`, `credit`,`status`,`rollback` FROM `logins` WHERE 	user_unique_id = ?");

                        $stmt->bind_param("s", $_GET['unique_id']);
                        $stmt->execute();
                        $stmt->bind_result($r_id, $r_fullname, $r_username, $usertype, $r_email_id, $r_pwd, $r_company, $r_profile, $r_mobile, $credit, $status, $rollback);
                        $stmt->fetch();
                        $conn->close();
                        ?>
                        <div class="row">
                                    ...
                                    <form class="form" method="post" action="process-edit-reseller.php"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4">
                                                <input class="form-control" type="text" placeholder="Mobile"
                                                       name="rslr_mobile"
                                                       id="rslr_mobile" value="<?php echo $r_mobile; ?>" required>
                                            </div>
                                            <label for="title" class="col-lg-2 col-form-label">Company </label>
                                            <div class="col-lg-4">
                                                <input class="form-control" type="text" placeholder="Company"
                                                       name="rslr_company"
                                                       id="rslr_company" value="<?php echo $r_company; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            style="width:22px; height:22px;"
                                                ...
                                                style="width:22px; height:22px;"
                                                <?php if ($rollback == "Disable") {
                                                            echo "checked";
                                                                }?>>&emsp;Disable
                                            </div>
                                            <label for="title" class="col-lg-2 col-form-label">User Type </label>
                                            <div class="col-lg-4">
                                                <select name="usertype" id="" class="form-control">
                                                    <?php if ($usertype == 'reseller') { ?>
                                                        <option value="<?php echo $usertype; ?>">Reseller</option>
                                                        <option value="User">User</option>
                                                    <?php } else { ?>
                                                        <option value="<?php echo $usertype; ?>">User</option>
                            ...
                            <div class="white-box" id="imge-popups">
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-striped">
                                        ...
                                        $sql = "SELECT `id`, `user_type` ,`user_unique_id`, `full_name` ,`username`, `email_id`, `mobile`, `credit`,`status` FROM `logins` WHERE `user_type`= 'reseller' order by id desc";
         ...
         <a href='reseller.php?action=view&unique_id=<?php echo $unique_id; ?>'
                                                           ...
                                                           title='View Details'><i
                                                                    class='fa fa-eye'></i></a>
        <a href='reseller.php?action=edit&unique_id=<?php echo $unique_id; ?>'
                                                        ...
                                                        <a title="Delete Reseller"
                                                           href="delete-reseller.php?id=<?php echo $id; ?>"
