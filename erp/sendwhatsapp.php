...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div style="border: 2px solid rgb(179,0,179);" class="white-box">
...
<!--                        </div>-->
                        <div class="form-group row">
                            <label for="title" class="col-lg-2 col-form-label" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>MESSAGE</h3><span class="mandatory" style="font-size: 13px;">* ( <b>*text*</b> , <i>_text_</i>, ~text~) </span></label>
                            <div class="col-lg-10">
                                <textarea style="border: 4px solid rgb(179,0,179);" name="description"  id="mytextarea" class="form-control" placeholder="Description"
                                          cols="10" rows="5"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="title" class="col-lg-2 col-form-label" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>MOBILE No.</h3><span class="mandatory" style="font-size: 13px;">*
                                (Please Add country code before mobile no.)</span></label>
                            <div class="col-lg-10">
                            <textarea style="border: 4px solid rgb(179,0,179);" onKeyUp="countline()" type="text" class="form-control required" required
...
91XXXXXXXXXX"
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label " for="userName" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>NUMBER COUNT</h3> <span
                                        class="mandatory">*</span></label>
                            <div class="col-lg-10">
                                <input style="border: 4px solid rgb(179,0,179);" type="text" class="form-control " readonly id="numbercount" required
                                       name="numbercount" value="">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group row">
                            <label for="photo" class="col-lg-2 col-form-label" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>IMAGE-1</h3>
                            </label>
                            <div class="col-lg-4">
                                <input style="border: 4px solid rgb(179,0,179);" type="file" id="photo-1" name="photo-1" class="form-control"
                                       accept="image/png,image/jpeg">
                                <p class="help-block text-danger">
                                    <small style="font-size: 13px;">Photo should be smaller than 2 MB. Only JPG and PNG are allowed.</small>
                                </p>
                            </div>

                            <label for="photo" class="col-lg-2 col-form-label"style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>IMAGE-2</h3>
                            </label>
                            <div class="col-lg-4">
                                <input style="border: 4px solid rgb(179,0,179);" type="file" id="photo-2" name="photo-2" class="form-control"
                                       accept="image/png,image/jpeg">
                                <p class="help-block text-danger">
                                    <small style="font-size: 13px;font-family: 'Ubuntu', sans-serif;">Photo should be smaller than 2 MB. Only JPG and PNG are allowed.</small>
                                </p>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="photo" class="col-lg-2 col-form-label" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>IMAGE-3</h3>
                            </label>
                            <div class="col-lg-4">
                                <input style="border:4px solid rgb(179,0,179);" type="file" id="photo-3" name="photo-3" class="form-control"
                                       accept="image/png,image/jpeg">
                                <p class="help-block text-danger">
                                    <small style="font-size: 13px;">Photo should be smaller than 2 MB. Only JPG and PNG are allowed.</small>
                                </p>
                            </div>
                            <label for="photo" class="col-lg-2 col-form-label" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>IMAGE-4</h3>
                            </label>
                            <div class="col-lg-4">
                                <input style="border: 4px solid rgb(179,0,179);" type="file" id="photo-4" name="photo-4" class="form-control"
                                       accept="image/png,image/jpeg">
                                <p class="help-block text-danger">
                                    <small style="font-size: 13px;">Photo should be smaller than 2 MB. Only JPG and PNG are allowed.</small>
                                </p>
...
<!--                            </select>-->
                            ...
                            <label for="pdf" id="pdf_f" class="col-lg-2 col-form-label" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>UPLOAD PDF</h3>
                            </label>
                            <div class="col-lg-4" id="pdf_file">
                                <input style="border:4px solid rgb(179,0,179);" type="file" id="p_file" name="pdf_file" class="form-control"
                                       accept="image/pdf">
                                <p class="help-block text-danger">
                                    <small style="font-size: 13px;">PDF should be smaller than 5 MB.</small>
                                </p>
                            </div>
...
<!--                            </div>-->
                        ...
                        <div class="form-group row">
                            <label for="video" id="video_f" class="col-lg-2 col-form-label" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>SEND VIDEO</h3>
                            </label>
                            <div class="col-lg-4" id="video_file">
                                <input style="border:4px solid rgb(179,0,179);" type="file" id="v_file"  name="video_file" class="form-control"
                                       accept="image/mp4,image/3gp, image/avi">
                                <p class="help-block text-danger">
                                    <small style="font-size: 13px;">Video should be smaller than 5 MB.</small>
                                </p>
                            </div>
                            <label for="photo" class="col-lg-2 col-form-label" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>DP IMAGE</h3>
                            </label>
                            <div class="col-lg-4">
                                <input style="border:4px solid rgb(179,0,179);" type="file" id="dp_image" name="dp_image" class="form-control"
                                       accept="image/png,image/jpeg">
                                <p class="help-block text-danger">
                                    <small style="font-size: 13px;font-family: 'Ubuntu', sans-serif;"> <b>Above 1000 Numbers</b> </small>
                                </p>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group row">
                            <label for="video" id="video_f" class="col-lg-2 col-form-label" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>REPLY BUTTON 1</h3>
                            </label>
                            <div class="col-lg-4" id="video_file">
                                <input style="border: 4px solid rgb(179,0,179);" type="text" id="replybutton1"  name="replybtn1" class="form-control" placeholder="Enter button text">
                            </div>
                            <label for="photo" class="col-lg-2 col-form-label" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>REPLY BUTTON 2</h3>
                            </label>
                            <div class="col-lg-4">
                                <input style="border:4px solid rgb(179,0,179);" type="text" id="replybutton2"  name="replybtn2" class="form-control" placeholder="Enter button text">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="video" id="video_f" class="col-lg-2 col-form-label" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>CALL-TO-ACTION BUTTON 1</h3>
                            </label>
                            <div class="col-lg-4" id="video_file">
                                <input style="border:4px solid rgb(179,0,179);" type="text" id="ctabtn1"  name="ctabtn1" class="form-control" placeholder="url|Visit Here|https://google.com">
                            </div>
                            <label for="photo" class="col-lg-2 col-form-label" style="font-size: 16px;font-family: 'Ubuntu', sans-serif;"> <h3>CALl-TO-ACTION BUTTON 2</h3>
                            </label>
                            <div class="col-lg-4">
                                <input style="border:4px solid rgb(179,0,179);" type="text" id="ctabtn2"  name="ctabtn2" class="form-control" placeholder="call|Contact Us|91XXXXXXXXXX">
                            </div>
                        </div>
                        <!-- Code by devendra for button end -->
                        <div class="form-group row">
                            <div class="col-lg-12 text-center">
                                <button id="btnn"  type="submit" name="submit"
                                        class="btn btn-success waves-effect waves-light m-r-10" style="font-size: 20px; font-family: 'Ubuntu', sans-serif;border-radius: 10px;width:12pc" > <h3 style="color:white">SUBMIT</h3>
                                </button>
                            </div>
                        </div>
                    </form>
