    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse slimscrollsidebar">
            <ul class="nav" id="side-menu">
                ...
                <li> <a href="sendwhatsapp.php" class="waves-effect"><i class="ti-email p-r-10"></i> <span class="hide-menu">Send SMS</span></a> </li>
                ...
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="O"></i> <span class="hide-menu">Sms Report <span class="fa arrow"></span></span></a>
                    <ul class="nav nav-second-level">
