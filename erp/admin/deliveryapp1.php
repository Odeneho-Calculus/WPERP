            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <div class="form-group row">
                        <?php if (!empty($photo1)) { ?>
                            ...
                            <div class="col-lg-2">
                                ...
                                <br/>
                                <a href="img/upload/<?php echo $photo1; ?>" class="btn btn-outline-warning"
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-lg-2 control-label" for="Created At">Button 1 </label>
                        <div class="col-lg-10"><span class="label label-info"
                         style="font-size:12px;"><?php echo $rplybtn1; ?></span>
                        </div>
                        <?php } ?>
                        <?php if (!empty($rplybtn2)) { ?>
                        <label class="col-lg-2 control-label" for="Created At">Button 2 </label>
                        <div class="col-lg-10"><span class="label label-info"
                         style="font-size:12px;"><?php echo $rplybtn2; ?></span>
                        </div>
                        <?php } ?>
                        <?php if (!empty($cta1)) { ?>
                        <label class="col-lg-2 control-label" for="Created At">Call-to-action button 1 </label>
                        <div class="col-lg-10"><span class="label label-info"
                         style="font-size:12px;"><?php echo urldecode($cta1); ?></span>
                        </div>
                        <?php } ?>
                        <?php if (!empty($cta2)) { ?>
                        <label class="col-lg-2 control-label" for="Created At">Call-to-action button 2 </label>
                        <div class="col-lg-10"><span class="label label-info"
...
<footer class="footer text-center">
    <script>document.write(new Date().getFullYear())</script> &copy; Designed by <a href="http://divineinfosec.com/">Divine Infosec</a></footer>
