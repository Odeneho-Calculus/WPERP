                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <?php if (!empty($u_profile)) { ?>
                                                <a href="../admin/img/upload/<?php echo $u_profile; ?>"
                                                   class="img-thumbnail waves-effect waves-light zoom-mp-img">
                                                    <img src="../admin/img/upload/<?php echo $u_profile; ?>"
                                                    ...
                                                    <td>
                                                        <a href='user.php?action=view&unique_id=<?php echo $unique_id; ?>'
                                                           ...
                                                           title='View Details'><i
                                                                    class='fa fa-eye'></i></a>
                                                        <a href='user.php?action=edit&unique_id=<?php echo $unique_id; ?>&rollback=<?php echo $reseller_rollback; ?>'
